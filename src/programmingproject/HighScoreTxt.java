...
public class HighScoreTxt {
    ...
    public static void Load() {
        try {
            ...
            br = new BufferedReader(new FileReader("src/resources/HighScores.txt"));
    ...
    public static void Save() {
        ...
        try {
            ...
            File file = new File("src/resources/HighScores.txt");
    ...
    public static void clear() {
        try {
            FileWriter fwOb = new FileWriter("src/resources/HighScores.txt", false);
